source "docker" "knowledge-matchmaker-corpus-indexer-service" {
...
build {
  sources = ["source.docker.knowledge-matchmaker-corpus-indexer-service"]
  ...
  post-processor "docker-tag" {
    repository = "svanosselaer/knowledge-matchmaker-corpus-indexer-service"
