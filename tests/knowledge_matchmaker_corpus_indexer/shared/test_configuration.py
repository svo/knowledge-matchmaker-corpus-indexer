...
from knowledge_matchmaker_corpus_indexer.shared.configuration import (
    ApplicationSettings,
...
class TestApplicationSettings:
    @patch("knowledge_matchmaker_corpus_indexer.shared.configuration.get_resource_path")
    @patch("knowledge_matchmaker_corpus_indexer.shared.configuration.load_properties_file")
...
class TestApplicationSettingProvider:
    @patch("knowledge_matchmaker_corpus_indexer.shared.configuration.ApplicationSettings")
