...
Welcome to ``knowledge-matchmaker-corpus-indexer`` contributor's guide. This project embraces clean architecture, Hexagonal Architecture, and Domain-Driven Design principles, so contributions should align with its modular, testable, and secure structure.
...
.. code:: bash
    ...
    git clone git@github.com:svo/knowledge-matchmaker-corpus-indexer.git
    cd knowledge-matchmaker-corpus-indexer
...
.. _issue tracker: https://github.com/svo/knowledge-matchmaker-corpus-indexer/issues
.. _repository: https://github.com/svo/knowledge-matchmaker-corpus-indexer
