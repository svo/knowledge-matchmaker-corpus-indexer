...
The project includes architectural tests using pytest-archon in `tests/knowledge_matchmaker_corpus_indexer/test_architecture.py` that enforce these rules automatically.

Run architectural tests:
```bash
pytest tests/knowledge_matchmaker_corpus_indexer/test_architecture.py -v
```
