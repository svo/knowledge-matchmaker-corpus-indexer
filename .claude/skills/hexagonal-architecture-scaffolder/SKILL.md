...
This skill guides you through scaffolding complete features across all layers of the hexagonal architecture used in this Knowledge Matchmaker Corpus Indexer project. It ensures proper layer separation, dependency injection, and adherence to project standards.
...
**Location:** `src/knowledge_matchmaker_corpus_indexer/domain/model/{feature_name}.py`
...
**Location:** `src/knowledge_matchmaker_corpus_indexer/domain/repository/{feature_name}_repository.py`
...
from typing import Optional
from uuid import UUID
from knowledge_matchmaker_corpus_indexer.domain.model.{feature_name} import FeatureName
...
**Location:** `src/knowledge_matchmaker_corpus_indexer/infrastructure/persistence/in_memory/in_memory_{feature_name}_repository.py`
...
from uuid import UUID
from knowledge_matchmaker_corpus_indexer.domain.model.{feature_name} import FeatureName
from knowledge_matchmaker_corpus_indexer.domain.repository.{feature_name}_repository import (
...
**Location:** `src/knowledge_matchmaker_corpus_indexer/application/use_case/{feature_name}_use_case.py`
...
**Location:** `src/knowledge_matchmaker_corpus_indexer/interface/api/data_transfer_object/{feature_name}_data_transfer_object.py`
...
**Location:** `src/knowledge_matchmaker_corpus_indexer/interface/api/controller/{feature_name}_controller.py`
...
from knowledge_matchmaker_corpus_indexer.application.use_case.{feature_name}_use_case import (
    GetFeatureNameUseCase,
    CreateFeatureNameUseCase
)
from knowledge_matchmaker_corpus_indexer.interface.api.data_transfer_object.{feature_name}_data_transfer_object import (
...
touch src/knowledge_matchmaker_corpus_indexer/domain/model/__init__.py
touch src/knowledge_matchmaker_corpus_indexer/domain/repository/__init__.py
touch src/knowledge_matchmaker_corpus_indexer/infrastructure/persistence/in_memory/__init__.py
touch src/knowledge_matchmaker_corpus_indexer/application/use_case/__init__.py
touch src/knowledge_matchmaker_corpus_indexer/interface/api/controller/__init__.py
touch src/knowledge_matchmaker_corpus_indexer/interface/api/data_transfer_object/__init__.py
```
...
- `tests/knowledge_matchmaker_corpus_indexer/domain/model/test_{feature_name}.py`
- `tests/knowledge_matchmaker_corpus_indexer/domain/repository/test_{feature_name}_repository.py`
- `tests/knowledge_matchmaker_corpus_indexer/infrastructure/persistence/in_memory/test_in_memory_{feature_name}_repository.py`
- `tests/knowledge_matchmaker_corpus_indexer/application/use_case/test_{feature_name}_use_case.py`
- `tests/knowledge_matchmaker_corpus_indexer/interface/api/controller/test_{feature_name}_controller.py`
- `tests/knowledge_matchmaker_corpus_indexer/interface/api/data_transfer_object/data_transfer_object/test_{feature_name}_data_transfer_object.py`
...
from knowledge_matchmaker_corpus_indexer.infrastructure.persistence.in_memory.in_memory_{feature_name}_repository import (
...
```python
from knowledge_matchmaker_corpus_indexer.interface.api.controller.{feature_name}_controller import FeatureNameController
