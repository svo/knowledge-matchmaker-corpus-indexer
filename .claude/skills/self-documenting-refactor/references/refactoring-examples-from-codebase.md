...
This document provides concrete examples from the Knowledge Matchmaker Corpus Indexer codebase demonstrating the no-comments policy in practice. All examples are taken from actual production code.
...
**Location:** `src/knowledge_matchmaker_corpus_indexer/application/use_case/coconut_use_case.py:8-13`
...
**Location:** `src/knowledge_matchmaker_corpus_indexer/infrastructure/security/basic_authentication.py:19-25`
...
**Location:** `src/knowledge_matchmaker_corpus_indexer/interface/api/controller/coconut_controller.py:29-47`
...
**Location:** `src/knowledge_matchmaker_corpus_indexer/infrastructure/security/basic_authentication.py:55-64`
...
**Location:** `src/knowledge_matchmaker_corpus_indexer/interface/api/controller/coconut_controller.py:66-69`
...
**Location:** `src/knowledge_matchmaker_corpus_indexer/infrastructure/persistence/in_memory/in_memory_coconut_query_repository.py:12-20`
...
**Location:** `src/knowledge_matchmaker_corpus_indexer/infrastructure/security/basic_authentication.py:35-40`
...
**Location:** `src/knowledge_matchmaker_corpus_indexer/application/use_case/coconut_use_case.py`
...
**Location:** `src/knowledge_matchmaker_corpus_indexer/interface/api/controller/coconut_controller.py:84-94`
...
**Location:** `src/knowledge_matchmaker_corpus_indexer/infrastructure/security/basic_authentication.py:32-47`
...
**Location:** `src/knowledge_matchmaker_corpus_indexer/infrastructure/persistence/in_memory/in_memory_coconut_query_repository.py:23-27`
...
**Location:** `src/knowledge_matchmaker_corpus_indexer/interface/api/data_transfer_object/`
...
- `src/knowledge_matchmaker_corpus_indexer/application/use_case/coconut_use_case.py`
- `src/knowledge_matchmaker_corpus_indexer/interface/api/controller/coconut_controller.py`
- `src/knowledge_matchmaker_corpus_indexer/infrastructure/persistence/in_memory/in_memory_coconut_query_repository.py`
- `src/knowledge_matchmaker_corpus_indexer/infrastructure/security/basic_authentication.py`
